...
class ESPHue
{
	public:
		...
		void setGroupHue(byte groupNum, unsigned int hue);
		void setGroupBri(byte groupNum, byte bri);
		void setGroupSat(byte groupNum, byte sat);
		void setGroupOn(byte groupNum, byte state);
